...
able to detect misspecification between the 2PL and 3PL. % again

\\
\indent Contrary to these results, we did find that the TLI and CFI were very sensitive 

to detect misfit between the 2PL and 3PL in one-dimensional IRT. % twee dingen fout: 2PL 3PL en one-dimensional IRT
