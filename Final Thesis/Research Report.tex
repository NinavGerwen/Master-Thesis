...
For the TLI, negative values sometimes occurred under model misspecification, this can occur when the degrees of the hypothesized model are small and correlations among observed variables are low (Wang \& Wang, 2019).

The new fit index, based on the cocurrence of score patterns and their expected occurence, shows less promise. The values seem to not be different from one another, in fact, higher in incorrect model specification. 
