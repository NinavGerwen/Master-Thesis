...
For the TLI, negative values sometimes occurred under model misspecification, this can occur when the degrees of the hypothesized model are small and correlations among observed variables are low (Wang \& Wang, 2019). In the current study, we rounded these slightly negative values to 0. 
